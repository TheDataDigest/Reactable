  ...
  prependContent(
    tagList(
      ...
      div(style = "vertical-align:middle;text-align:center;background-color:black;color:#BBBBBB;padding-top:5px;padding-bottom:20px;font-size:14px;",
          "Analysis by https://www.youtube.com/c/TheDataDigest")
    )
  ) %>% 
  appendContent(
    p("Data from transfermarkt.com | Credit to: @tanya_shapiro",
      style = paste0(
...
saveWidget(html_object, "01_teams.html", selfcontained = TRUE)


## Version 0.2 ----
#### round age   # Round to 1 decimal place
Age_average = colDef(name = "AVG AGE", align = "center", maxWidth = 120, 
                     footer = "Mean age of players", 
...
#### fix labels
?scales::label_dollar # Show in help!
scales::label_dollar(scale = 1/1e6, suffix = " million")(1234000000)
scales::label_dollar(scale = 1/1e6, suffix = " million")( 420690000)
scales::label_dollar(scale = 1/1e6, suffix = " million", accuracy = 1)( 420690000)
...
saveWidget(table, "01_teams.html", selfcontained = TRUE)
